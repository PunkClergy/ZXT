...
*/
    ...
    getCarList: function() {
      var param = {};
      param[urlUtil.buyRecord.companyId] = getApp().data.userInfo.fin3CompanyId;
      param[urlUtil.buyRecord.page] = that.data.page;
      appUtil.showLoading("加载中...")
      appUtil.byPost(getApp().data.k1swUrl + urlUtil.buyRecord.URL, param, function(res) {
        appUtil.hideLoading();
        if (res) {
          var data = res.data;
          if (data.code == 1000) {
