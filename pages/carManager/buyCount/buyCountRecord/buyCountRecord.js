...
*/
    ...
    getCarList: function() {
      var param = {};
      param[urlUtil.buyCountRecord.companyId] = getApp().data.userInfo.fin3CompanyId;
      param[urlUtil.buyCountRecord.page] = that.data.page;
      appUtil.showLoading("加载中...")
      appUtil.byPost(getApp().data.k1swUrl + urlUtil.buyCountRecord.URL, param, function(res) {
        appUtil.hideLoading();
        if (res) {
          var data = res.data;
          if (data.code == 1000) {
