      ...
      if (res) {
        ...
        if (that.data.viewType == 1) {
         // prevPage.setData({ // 将我们想要传递的参数在这里直接setData。上个页面就会执行这里的操作。
          //  startPhotoPath: pathUrl,
          //  cellIndex: that.data.cellIndex,
         // });
         prevPage.updateStartPhoto(that.data.cellIndex,res.tempImagePath);
        } else if (that.data.viewType == 2) {
          prevPage.updateEndPhoto(that.data.cellIndex,res.tempImagePath);
