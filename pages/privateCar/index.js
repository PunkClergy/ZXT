...
Page({
  ...
  data: {
    ...
    allControlItems: [                           // 所有控制项配置
      { id: 1, name: '开锁', icon: 'https://k3a.wiselink.net.cn/img/app/blue/unlock_off.png', evt: 'handleUnlock' },
      { id: 2, name: '关锁', icon: 'https://k3a.wiselink.net.cn/img/app/blue/lock_off.png', evt: 'handleLock' },
      { id: 3, name: '尾箱', icon: 'https://k3a.wiselink.net.cn/img/app/blue/box_off.png', evt: 'handleOpenTrunk' },
      { id: 4, name: '寻车', icon: 'https://k3a.wiselink.net.cn/img/app/blue/search_off.png', evt: 'handleFindCar' },
      { id: 5, name: '配置', icon: 'https://k3a.wiselink.net.cn/img/app/blue/set.png', evt: '' },
    ],
  ...
  splitControlItems: function () {
    const pages = [];
    const itemsPerPage = 4;  // 每页4个控制项

    // 分组处理
    for (let i = 0; i < this.data.allControlItems.length; i += itemsPerPage) {
      pages.push(this.data.allControlItems.slice(i, i + itemsPerPage));
    }
  ...
  changeMode: function (e) {
    ...
    wx.showToast({
      title: `已切换至${newMode === 'manual' ? '手动模式' : '感应模式'}`,
      icon: 'none'
    });
  },
