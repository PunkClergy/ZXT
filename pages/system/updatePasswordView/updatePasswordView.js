...
Page({
  ...
  data: {
    ...
    vericode:"",
    oldPassword:"",
    oldSeeimg_url:"../../../assets/images/viewoff.png",
    oldSeepwd:true,

    newPassword:"",
    newSeeimg_url:"../../../assets/images/viewoff.png",
    newSeepwd:true,
   ...
   * 改变眼睛的状态
   */
  oldChangeSeeState: function () {

    that.setData({
      oldSeepwd: !that.data.oldSeepwd,
      oldPassword: that.data.oldPassword
    })
    if (that.data.oldSeepwd)
    {
      that.setData({
        oldSeeimg_url: "../../../assets/images/viewoff.png"
      })
    ...
    {
      that.setData({
        oldSeeimg_url: "../../../assets/images/view.png"
      })
    }
  },

  newChangeSeeState: function () {

    that.setData({
      newSeepwd: !that.data.newSeepwd,
      newPassword: that.data.newPassword
    })
    if (that.data.newSeepwd)
    {
      that.setData({
        newSeeimg_url: "../../../assets/images/viewoff.png"
      })
    ...
    {
      that.setData({
        newSeeimg_url: "../../../assets/images/view.png"
      })
    }
  },
  ...
  submitBtnTap: function () {
    ...
    param[urlUtil.updatePassword.USERNAME] = getApp().data.managerInfo.username;
    param[urlUtil.updatePassword.OLDPASSWORD] = that.data.oldPassword;
