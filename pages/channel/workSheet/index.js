...
Page({
  ...
  getOrderList() {
    showLoading("加载中...");
    const param = {
      [u_nodeDetailGroupList.comParam]: this.data.g_comParam,
      [u_nodeDetailGroupList.page]: this.data.g_page,
    };
    byGet(getApp().data.k1swUrl + u_nodeDetailGroupList.URL, param).then(response => {
      hideLoading()
