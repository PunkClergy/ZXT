...
function getBLEDeviceReadCharacteristics() {
  wx.getBLEDeviceCharacteristics({
    ...
    success: function (res) {
      ...
      logger.e('device设备的读Random值特征值id:' + gReadRandomCharacteristic);
...
function onBLECharacteristicValueChange() {
  wx.onBLECharacteristicValueChange(function (characteristic) {
    ...
    if(characteristic.characteristicId.indexOf(READRANDOM_CHARACTERISTIC_SHORTHAND)!=-1){
      ...
      gOnReceiveValue(utils.hexCharCodeToStr(receiverHexData),'secretkey');
...
function onBluetoothDeviceFound() {
  ...
  wx.onBluetoothDeviceFound(function (devices) {
    console.log('device found:333333  ' + devices.devices[0].name);
...
function connectMyBLE(idc, bluetoothState, onReceiveValue, isIntercept) {
  console.log(idc, bluetoothState, onReceiveValue, isIntercept,'2222222222222222222222222222[[[[')
...
function connectBLE(idc, bluetoothState, onReceiveValue) {
  console.log(idc,bluetoothState,onReceiveValue,'[[[[[[[[[[[[[[11111')
...
module.exports = {
  ...
  dispatcherSend2: dispatcherSend2,
